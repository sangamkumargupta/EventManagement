<?php
  ...
  try {
      ...
      $mail->Password   = 'zwdrwtsewchpoybi';                  
      ...
      if(!empty($_REQUEST['Pay']) && $_REQUEST['Pay']== 'Pay'){
          ...
          if($eventPayment && $result){
            $mail->addAddress($_REQUEST['bookEmail']);
            $mail->isHTML(true);                                  
            $mail->Subject = 'For Booking';
            ...
            Dear '.$_REQUEST['candidateName'].',
            
            </p>
            <p>Your most wel-come in SS Event Management.<br/> And 
            Thank you for booking the ' .$eventsName.'  event in my SS Event Management.
            <br/>Your event date: <b> '.$_REQUEST['evetDate'].'</b>
            <br/>Number Of Guest:<b> '.$_REQUEST['numOfGuest'].'</b>
            <br/>Your Total Amount:<b> '.$_SESSION['total'].'</b>
            <br/>Your Paid Amount: <b> '.$_SESSION['total'].'</b> </p>
            
            <p>Thank you,<p>
            <h3>'.$_REQUEST['candidateName'].'</h3>
            </body>
            </html>';
            //$mail->Body    = '<h3>Thank You</h3><br/><h1 style="color:red;">'..'</h1>';
            $mail->Body=$msg;
